...
hotp.gen = function (key, opt) {
  ...
  var b = bytesToHex(intToBytes(counter));
  ...
  // PORT from node version: replace Crypto library with CryptoJS
  var k = crypto.enc.Hex.parse(b);
  var digest = crypto.HmacSHA1(k, key).toString();
