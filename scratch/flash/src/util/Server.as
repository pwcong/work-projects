...
public class Server implements IServer {
	...
	protected function setDefaultURLs():void {
		 ...
		 * 设置静态资源路径
		 */
		URLs['siteCdnPrefix'] = 'cdn/';
		URLs['staticFiles'] = '';
		URLs['assetCdnPrefix'] = 'cdn/';
		URLs['internalAPI'] = '';
	...
	public function serverPost(url:String, data: *, whenDone: Function): URLLoader{
		return callServer(url, data, null, whenDone);
	}
